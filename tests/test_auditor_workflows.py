...
class TestParsedLint(unittest.TestCase):
    ...
    def test_census_recount_over_all_26_workflows(self):
        ...
        26 workflows, 56 jobs, 317 steps, 147 run entries."""
        ...
        self.assertEqual(total, {"jobs": 56, "steps": 317, "runs": 147})
    ...
    def test_every_run_entry_passes_bash_n_decoded(self):
        ...
        run entry Psych finds — all spellings, both directories, exactly 147.
...
class TestLintClean(unittest.TestCase):
    ...
    def test_every_run_block_passes_bash_n(self):
        ...
        (`parsed_run_steps`, #165) does; it finds 147 run entries today, all block-scalar
        ...
        # (`parsed_run_steps`, #165) finds 147 run entries today, matching this count exactly
        ...
        self.assertGreater(expected, 100,
                           f"the corpus should hold ~147 run blocks, found {expected} — the "

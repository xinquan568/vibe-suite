...
class TestParsedLint(unittest.TestCase):
    ...
    def test_census_recount_over_all_26_workflows(self):
        ...
        26 workflows, 52 jobs, 298 steps, 139 run entries."""
        ...
        self.assertEqual(total, {"jobs": 52, "steps": 298, "runs": 139})
...
class TestLintClean(unittest.TestCase):
    ...
    def test_every_run_block_passes_bash_n(self):
        ...
        (`parsed_run_steps`, #165) does; it finds 139 run entries today, all block-scalar
        ...
        # (`parsed_run_steps`, #165) finds 139 run entries today, matching this count exactly
        ...
        self.assertGreater(expected, 100,
                           f"the corpus should hold ~139 run blocks, found {expected} — the "

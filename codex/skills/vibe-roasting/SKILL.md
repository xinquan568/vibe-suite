...
<!-- GENERATED by scripts/mirror-sync.py from skills/roasting/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->


# roasting — the code-interrogation criteria

What `$vibe-roast` reviews by. The command owns arguments, dispatch and the report; this skill
owns the dimensions, the styles and the add-ons.

**This is code review. NL-artifact review is [`../vibe-auditing/SKILL.md`](../vibe-auditing/SKILL.md).** The two
...
[`../vibe-vibe-core/SKILL.md`](../vibe-vibe-core/SKILL.md) (`skills/vibe-core/SKILL.md`) § Untrusted input.

...
argument-hint: "<item-id> [--profile <id>] [--review-mode none|single|full] [--max-review-rounds N] [--scenario auto|new-feature|bug-fix|docs] [--allow-self-review] | profile init | chain <item-id>... | resume <run-id> | iterate <run-id> [--max-review-rounds N] | list"
---

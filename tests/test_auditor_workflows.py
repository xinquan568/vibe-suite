...
class TestParsedLint(unittest.TestCase):
    ...
    def test_census_recount_over_all_26_workflows(self):
        ...
        26 workflows, 51 jobs, 293 steps, 137 run entries."""
        ...
        self.assertEqual(total, {"jobs": 51, "steps": 293, "runs": 137})
    ...
    def test_every_run_entry_passes_bash_n_decoded(self):
        ...
        run entry Psych finds — all spellings, both directories, exactly 137.
...
class TestLintClean(unittest.TestCase):
    ...
    def test_every_run_block_passes_bash_n(self):
        ...
        (`parsed_run_steps`, #165) does; it finds 137 run entries today, all block-scalar
        ...
        # (`parsed_run_steps`, #165) finds 137 run entries today, matching this count exactly
        ...
        self.assertGreater(expected, 100,
                           f"the corpus should hold ~137 run blocks, found {expected} — the "

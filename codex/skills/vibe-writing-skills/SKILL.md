...
<!-- GENERATED by scripts/mirror-sync.py from skills/writing-skills/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
> [conventions-claude](../vibe-conventions-claude/SKILL.md),
> [conventions-codex](../vibe-conventions-codex/SKILL.md), and
> [conventions-antigravity](../vibe-conventions-antigravity/SKILL.md).
> For writing agents see [writing-agents](../vibe-writing-agents/SKILL.md); for

...
<!-- GENERATED by scripts/mirror-sync.py from skills/patterns/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
- **Penalty.** The [vibe-suite:scoring](../vibe-scoring/SKILL.md) rubric applies -2 per occurrence, capped at -20.
...
- Per-artifact-type schema and syntax details — see [vibe-suite:conventions](../vibe-conventions/SKILL.md)
- The scoring rubric and penalty tables — see [vibe-suite:scoring](../vibe-scoring/SKILL.md)

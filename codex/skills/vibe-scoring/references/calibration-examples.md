<!-- GENERATED by scripts/mirror-sync.py from skills/scoring/references/calibration-examples.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->

...
| [ADR-0003](0003-rawoutput-fidelity-boundary.md) | A capped `rawOutput` carries only what the engine emitted | Accepted | 2026-09-11 |
| [ADR-0004](0004-authoritative-job-records-carry-the-ownership-stamp.md) | Authoritative job records must carry the ownership stamp | Accepted | 2026-09-18 |

...
<!-- GENERATED by scripts/mirror-sync.py from skills/conventions-codex/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
universal [conventions](../vibe-conventions/SKILL.md) floor states what every agent
...
Antigravity divergence (see [conventions-antigravity](../vibe-conventions-antigravity/SKILL.md)).
...
Claude's 2026-06 event set — see the [conventions-claude](../vibe-conventions-claude/SKILL.md)
...
[conventions](../vibe-conventions/SKILL.md) floor; penalty tables stay with the

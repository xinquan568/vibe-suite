---
name: vibe-conventions-antigravity
...
<!-- GENERATED by scripts/mirror-sync.py from skills/conventions-antigravity/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
library. The universal [conventions](../vibe-conventions/SKILL.md) floor covers
...
[conventions-codex](../vibe-conventions-codex/SKILL.md) §6 for that side).

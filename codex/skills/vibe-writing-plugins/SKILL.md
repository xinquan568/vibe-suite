...
<!-- GENERATED by scripts/mirror-sync.py from skills/writing-plugins/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
> skills under `.agents/skills/` — see [conventions-codex](../vibe-conventions-codex/SKILL.md))
...
> [conventions-antigravity](../vibe-conventions-antigravity/SKILL.md)).
> A bare collection of SKILL.md files needs no plugin wrapper at all and installs
> into any tool with `npx skills add` — see [writing-skills](../vibe-writing-skills/SKILL.md).
> For authoring the individual components, see
> [writing-skills](../vibe-writing-skills/SKILL.md),
> [writing-agents](../vibe-writing-agents/SKILL.md),
> [writing-hooks](../vibe-writing-hooks/SKILL.md), and
> [writing-rules](../vibe-writing-rules/SKILL.md).

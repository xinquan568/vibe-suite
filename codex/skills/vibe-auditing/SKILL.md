...
<!-- GENERATED by scripts/mirror-sync.py from skills/auditing/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
**This is judgment, not lint.** The [scoring](../vibe-scoring/SKILL.md) skill is the deterministic half of
...
a command. See [`../vibe-vibe-core/SKILL.md`](../vibe-vibe-core/SKILL.md) § Untrusted input.
...
`../vibe-vibe-core/SKILL.md`'s scale — `[CRITICAL]`, `[HIGH]`, `[MEDIUM]`, `[LOW]`, `[GOOD]` — and the
...
- Vague quantifiers — the eleven terms R01 counts, listed in the [rules](../vibe-rules/SKILL.md) skill —
...
[security](../vibe-security/SKILL.md) pattern database own execution-surface discovery, the severity
...
[`../../commands/shared/discover.md`](references/discover.md), classify with
[`../../commands/shared/classify.md`](references/classify.md), then apply the check set
...
Findings use the six-field shape defined in [`../vibe-vibe-core/SKILL.md`](../vibe-vibe-core/SKILL.md)

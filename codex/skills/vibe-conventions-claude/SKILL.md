...
<!-- GENERATED by scripts/mirror-sync.py from skills/conventions-claude/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
Overlay on the universal [conventions floor](../vibe-conventions/SKILL.md). Floor
...
- This overlay covers Claude Code schemas only; universal rules live in the
  [floor](../vibe-conventions/SKILL.md), and penalty values live in the suite
  scoring rubric.

...
Exit codes: 0 ran: changes applied, none needed, or reported by --dry-run without writing · 2 the root is not a directory or was refused as a containment root (for example a symlink), or usage · 3 a write was refused by the atomic primitive
"""

...
<!-- GENERATED by scripts/mirror-sync.py from skills/vocabulary/SKILL.md — do not edit. Slash commands refer to the Claude-side vibe-suite plugin; source paths refer to the vibe-suite repository. -->
...
- The [conventions](../vibe-conventions/SKILL.md) skill owns upstream framework
...
- Framework-defined terms: [conventions](../vibe-conventions/SKILL.md).
- The quality-rule catalog that hosts R51: [rules](../vibe-rules/SKILL.md).
- Penalty tables and calibration: [scoring](../vibe-scoring/SKILL.md).
